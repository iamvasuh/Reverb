package com.example.user.reverb.fragments
...
import com.example.user.reverb.CurrentSongHelper
import com.example.user.reverb.R
import com.example.user.reverb.Songs
import com.example.user.reverb.databases.ReverbDatabase
import java.util.*
...
class SongPlayingFragment : Fragment() {
    ...
    object Statified {
        ...
        var favoriteContent: ReverbDatabase? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        Statified.favoriteContent = ReverbDatabase(Statified.myActivity)
